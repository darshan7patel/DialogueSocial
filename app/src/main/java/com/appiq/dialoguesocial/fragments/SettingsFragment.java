...
public class SettingsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null){
            ...
            TextView textViewEmail = view.findViewById(R.id.user_email);
                    ...
                    mGoogleSignInClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            getActivity().getSupportFragmentManager().beginTransaction()
                                    ...
                                    .commit();
                            Toasty.normal(getActivity(), "Successfully Logged Out", Toasty.LENGTH_SHORT).show();
                        }
                    });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GOOGLE_SIGN_IN_CODE){
            ...
            try {
                ...
                e.printStackTrace();
                Toasty.info(getActivity(),"Please select an appropriate Account", Toasty.LENGTH_SHORT).show();
            }
        }
    }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            getActivity().getSupportFragmentManager().beginTransaction()
                                    .replace(R.id.content_area, new SettingsFragment())
                                    .commit();
                            Toasty.success(getActivity(),"Successfully Logged In", Toasty.LENGTH_SHORT).show();
                        }else {
                            Toasty.error(getActivity(),"Login Failure", Toasty.LENGTH_SHORT).show();
                        }
                    }
                });
    }
